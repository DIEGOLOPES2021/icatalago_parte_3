...
?>
<link rel="stylesheet" href="/Aula-PHP/catalogo-produtos/icatalogo-parte1/componentes/header/header.css">
...
<header class="header">
    <figure>
        <img src="/Aula-PHP/catalogo-produtos/icatalogo-parte1/imgs/logo.png" />
    </figure>
    ...
    if (!isset($_SESSION["usuarioId"])) {
        ...
        <div class="container-login" id="container-login">
            <h1>Fazer login</h1>
            <form method="POST" action="/Aula-PHP/catalogo-produtos/icatalogo-parte1/componentes/header/acoesLogin.php">
    ...
    ?>
        ...
        <form id="form-logout" style="display: none;" method="POST" action="/Aula-PHP/catalogo-produtos/icatalogo-parte1/componentes/header/acoesLogin.php">
